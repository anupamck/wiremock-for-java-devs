...
public class MoviesAppConstants {
    ...
    public static final String MOVIES_BY_NAME_QUERY_PARAM_V1 = "/movieservice/v1/movieName";
    public static final String MOVIES_BY_YEAR_QUERY_PARAM_V1 = "/movieservice/v1/movieYear";
